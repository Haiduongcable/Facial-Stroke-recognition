...
def train(model,n_epochs, learningrate, train_loader, test_loader, use_sam=False):
    ...
    for epoch in range(n_epochs):
        ...
        for i, sample_batch in enumerate(tqdm(train_loader)):
            ...
            landmark_data = landmark_data.to(device)
            label = label.to(device)

            output = model(facial_data, landmark_data)
        ...
        with torch.no_grad():
            ...
            for i, sample_batch in enumerate(tqdm(test_loader)):
                ...
                val_output = model(facial_data, landmark_data)
...
def main():
    ...
    model = Double_Net(num_class = num_class)
    print(model)
    #Checkpoint save
    ...
    PATH= checkpoint_dir + '/double_net.pt'
    model_name='double_net'
